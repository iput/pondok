...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>login"><b>Gasek</b>MultiMedia</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Gunakan email dan sandi yang telah anda daftarkan</p>
