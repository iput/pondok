...
<body>
    ...
    <!-- HEADER END-->
<?php $this->load->view('attribute/nav_user'); ?>
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
    ...
    <!-- JAVASCRIPT AT THE BOTTOM TO REDUCE THE LOADING TIME  -->
            <!-- CORE JQUERY SCRIPTS -->
    <script src="<?php echo base_url('assets/bootstrap/js/jquery-2.2.3.js') ?>"></script>
    <script src="<?php echo base_url('assets/bootstrap/js/jquery-1.11.1.js') ?>"></script>
    <!-- BOOTSTRAP SCRIPTS  -->
